...
class MosqueUserList extends StatefulWidget {
  ...
  MosqueUserList({required this.client,required this.onItemTap,this.type,this.title,this.onAddEmployee,this.supervisorId});
  @override
...
class _MosqueUserListState extends State<MosqueUserList> {
  ...
  void searchRecords(bool isReload){
    ...
    _userService!.getMosqueUser(10,data.pageIndex,_controller.text,this.widget.type??"",this.widget.supervisorId).then((value){
                    ...
                    return Container(
                      ...
                      child: ListTile(
                        leading: ImageData(id:data.list[index].id!,modelName: Model.employee,fieldId: "avatar_128",width: 30,height: 40,
                          uniqueId: data.list[index].uniqueId,baseUrl: userProvider.baseUrl,headersMap:_userService==null?'':_userService!.headersMap ,),
